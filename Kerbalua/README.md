The [Lua engine](https://www.lua.org/manual/5.2/) uses [MoonSharp](http://www.moonsharp.org/). MoonSharp is a lua implementation
that can interact with Mono/C# objects. KSP is implemented in C# Mono. Using MoonSharp our engine can interact with the [KSP api](https://kerbalspaceprogram.com/api/annotated.html) ingame. We can provide in scripting nearly any functionality a modmaker would normally have to access with C#.
