...
#pragma warning restore 618
		...
		/// <summary>
		/// If set to true, will cause a force yield before the next instruction
		/// executed in any coroutine that is associated with this script. Will be reset
		/// to false immediately after force-yielding.
		/// </summary>
		public bool ForceYield { get; set; } = false;

		public void SetTimedInterrupt(long tickLimit)
		{
			TickLimit=tickLimit;
			TimedInterruptActive=true;
