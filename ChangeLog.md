...
- [Science API](RedOnion.KSP/API/Science.md), science.ros (supports DMagic's Orbital Science and DMModuleScienceAnimateGeneric)
- [OS/Process API](RedOnion.KSP/API/OperatingSystem.md) (early version of MunOS API for scripts)
