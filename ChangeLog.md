...
- ROS redesign.
- Better Autopilot. Needs to handle all torque possibilities, work better with control structures, and probably use PIDs. I'd also like a better relative direction system that does not go wonky near the poles for polar orbits. (Example: You're approaching north pole, you've specified your ship to have a heading of due north, then suddenly you reach the north pole and now instantly your ship is headed south.)
